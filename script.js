...
function computeApproxRows(g, historyArr, budouCount, cherryCount, spec, extraBig, extraReg) {
...
function updateApproximationTable() {
    ...
    const rowsWhole = computeApproxRows(gWhole, t.history, t.budou, t.cherry, spec, t.prevBig || 0, t.prevReg || 0);
    ...
    const rowsOwn = computeApproxRows(ownGames, ownHistory, t.budou, t.cherry, spec);
